...
var createAndSavePerson = function(done) {
  ...
  person=new Person({name:"Achal",age:"24",favoriteFoods:["Pav Bhaji","Chhole Bhature","Shahi Paneer"]});
...
person=new Person({name:"Anuj",age:"20",favoriteFoods:["Malai Kofta","Manchurian","Shahi Paneer"]});
person.save(function(err, data) {
    console.log("Saved");
